...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est CAMARA Daouda ')
.pauseFor(300)
.typeString('<strong>, Développeur Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)
// // daouda 
// .typeString('<strong>, Développeur Symfony | PHP </strong> !')
// .pauseFor(1000)
// .changeDelay(5)
// // daouda
.typeString('<span style="color: red;"> Développeur Symfony | PHP </span> !')
.pauseFor(1000)
.deleteChars(29)
.typeString('<span style="color: red;"> PHP</span> !')
.pauseFor(1000)
.deleteChars(22)
